"Steam/cached/AccountPage.res"
{
	...
	styles
	{
		CAccountPage
		{
			render_bg
			{
				0="image(x0,y0+8,x1,y1, graphics/metro/labels/settings/youraccount)"
				1="image(x0,y0+111,x1,y1, graphics/metro/labels/settings/securityinfo)"
				2="image(x0,y0+306,x1,y1, graphics/metro/labels/settings/betaparticipation)"
			}
		}
	}
	layout
	{
		//Upper Right
		place { control="AccountLink" align=right y=8 }

		//Avatar
		place { control="SecurityIcon" dir=right y=36 spacing=8 }

		///Information
		place { control="AccountInfo" dir=right width=max x=68 y=31 spacing=8 }
		place { control="EmailInfo" x=68 y=56 }
		place { control="NoPersonalInfoCheck" x=68 y=81 height=18 width=max spacing=8 }

		//Security Information
		place { control="SecurityStatusState,VACInfoLink" y=116 margin-top=16 width=max height=28 dir=down }
		place { start=SecurityStatusState control="ChangeUserButton,ManageSecurityButton,ChangePasswordButton,ChangeContactEmailButton" y=14 margin-top=16 height=28 dir=down spacing=8 }

		//Beta Participation
		place { control="CurrentBetaLabel" y=315 margin-top=16 dir=down width=max }
		place { start=CurrentBetaLabel control="ChangeBetaButton" y=7 width=84 height=28 spacing=8 dir=down }
		place { start=ChangeBetaButton control="ReportBugLink" y=7 dir=down }

		//Hidden
		place { control="Label1,Label2,BetaParticipationLabel,Label,Divider1,Divider2,SecurityStatusLabel,LogOutLabel,ContactEmailLabel" height=0 }
	}
}
